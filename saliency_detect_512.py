...
parser.add_argument('--image-folder', type=str, default='messidor-2/preprocess_saliency_2',help='path to image folder')
parser.add_argument('--output-folder', type=str,default='messidor-2_new/preprocess_saliency' ,help='path to save saliency map')
parser.add_argument('--visualize-folder', type=str, default='messidor-2_new/preprocess_saliency_2', help='path to save saliency map visualizeualization')
...
def main():
    ...
    for folder, _, imgs in os.walk(args.image_folder):
        ...
        for img in imgs:
            ...
            saliency_detect(i, args.saliency_model, src_path, output_path, visualize_path)
